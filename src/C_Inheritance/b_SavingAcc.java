...
public class b_SavingAcc extends a_BankAcc{
	...
	public b_SavingAcc(String name, int acc_no, double amount) {
		// super ဆိုတာ parent class ကို ကိုယ်စားပြုခြင်းဖြစ်ပြီး သူ့ကို Constructor ရဲ့ ထိပ်ဆုံးလိုင်းမှာ ရေးပေးရတယ် မရေးရင် Error တက်တယ်
